...
extern "C" unsigned char m68ki_cycles[NUM_CPU_TYPES][0x10000] = { 0 }; /* Cycles used by CPU type */
extern "C" void  (*m68ki_instruction_jump_table[0x10000])(void) = { 0 }; /* opcode handler jump table */

extern "C" unsigned int m68k_set_fc(unsigned int fc) {
	return 0;
}

extern "C" int m68k_read_memory_8(unsigned int address) {
	return 0;
}
extern "C" int m68k_read_memory_16(unsigned int address) {
	return 0;
}
extern "C" int m68k_read_memory_32(unsigned int address) {
	return 0;
}
